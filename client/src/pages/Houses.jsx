...
const policy = [
    { k: 'gio-gic-tu-do', t: 'Giờ giấc tự do' },
  { k: 'nuoi-thu-cung', t: 'Nuôi thú cưng' },
  { k: 'nha-khong-o-chung-chu', t: 'Nhà không ở chung chủ' },
 
]
/** Mock data Nhà (thay bằng API sau) */
const MOCK_HOUSES = Array.from({ length: 36 }).map((_, i) => ({
  id: i + 1,
  title: `Nhà phố 2 tầng, hẻm ô tô, thoáng sáng #${i + 1}`,
  price: [8000000, 12000000, 15000000, 18000000, 22000000, 30000000][i % 6],
  area: [50, 60, 75, 90, 120, 150, 200][i % 7],
  addr: ['Q.7, TP.HCM', 'Q.1, TP.HCM', 'Bình Thạnh, TP.HCM', 'TP. Thủ Đức'][i % 4],
  img: `https://picsum.photos/seed/house${i + 201}/1200/800`,
  vip: i % 4 === 0,
        ...
        <div className="container rebar__inner">
          <form className="rebar-search" onSubmit={e => { e.preventDefault(); setPage(1) }}>
            <div className="re-input re-input--grow">
              ...
              <input value={q} onChange={e => setQ(e.target.value)} placeholder="Từ khoá, khu vực, tuyến đường..." />
            </div>
